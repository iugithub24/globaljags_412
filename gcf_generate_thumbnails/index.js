...
exports.generateThumbnail = async (file, context) => {
  ...
  if (validFile) {
    ...
    const finalImageUrl = `https://storage.googleapis.com/${finalBucket.name}/${finalFileName}`;
    ...
    const thumbUrl = `https://storage.googleapis.com/${thumbnailsBucket.name}/${thumbName}`;
